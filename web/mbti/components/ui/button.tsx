...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-indigo-600 text-white shadow-md hover:bg-indigo-700 active:scale-95 focus-visible:ring-indigo-500',
        secondary:
        ...
        outline:
          'border border-gray-200 bg-white text-gray-900 hover:bg-gray-50 active:scale-95 focus-visible:ring-indigo-500',
        destructive:
          'bg-red-500 text-white shadow-sm hover:bg-red-600 active:scale-95 focus-visible:ring-red-500',
      },
      size: {
